...
accelerate launch --mixed_precision fp16 --num_processes $num_process --main_process_port $master_port run.py \
  --task_name long_term_forecast \
  --is_training 1 \
  --root_path ./dataset/ETT-small/ \
  --data_path ETTh1.csv \
  --model_id ETTh1_96_96 \
  --model $model_name'_'$base_model \
  --data ETTh1 \
  --features M \
  --seq_len 96 \
  --label_len 48 \
  ...
  --llm_dim 1024 \
  --draw_mse \
  --ds_config ds_config_zero2_gpt2.json
